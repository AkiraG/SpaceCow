...
class Map:
    ...
    def __init__(self, sound):
        ...
        self.flags = pygame.SCALED | pygame.DOUBLEBUF | pygame.HWSURFACE
        self.screen = pygame.display.set_mode((1024, 768), self.flags, 32)
        self.speed = 1
    ...
    def new_level(self):
        ...
        for nave in range(self.num_ship):
            nave = Ship()
    ...
    def main_menu(self):
        ...
        texto5 = self.texto4.render(
            "Programmers: Gabriel 'Sensei' Faggione / George 'Shisho' Dourado / Lucas 'Jesus' Moura", 0, (0, 0, 0))
